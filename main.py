...
def get_args_parser():
    ...
    parser.add_argument('--meta_arch', default='temp_rmot', type=str)
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='e2e_rmot')
    ...
    parser.add_argument('--sampler_steps', type=int, default=[60, 80, 90], nargs='*')
    parser.add_argument('--sampler_lengths', type=int, default=[5, 5, 5, 5], nargs='*')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            if epoch >30 and (epoch + 1) % 5 == 0: #original= 10 每隔10个epoch保存一次模型
